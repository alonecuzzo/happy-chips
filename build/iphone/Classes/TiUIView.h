...
/**
 Base class for all happy_chips views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the happy_chips view hierarchy (such as wrapped iOS UIViews) was touched.
