 ...
 * Copyright (c) 2009-2011 by happy_chips, Inc. All Rights Reserved.
...
//@interface happy_chipsObject : NSObject
//@end

@interface happy_chipsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[happy_chipsObject class]])
		{
			for (NSString *key in [[(happy_chipsObject*)o modules] allKeys])
			{
