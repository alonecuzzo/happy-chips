...
// in simulator we redefine to format for happy_chips Developer console
...
{\
	NSString * exceptionName = [@"org.happy_chips." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.happy_chips";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIhappy_chipsNativeItemNone = -1, 
	UIhappy_chipsNativeItemSpinner = -2,
	UIhappy_chipsNativeItemProgressBar = -3,
	
	UIhappy_chipsNativeItemSlider = -4,
	UIhappy_chipsNativeItemSwitch = -5,
	UIhappy_chipsNativeItemMultiButton = -6,
	UIhappy_chipsNativeItemSegmented = -7,
	
	UIhappy_chipsNativeItemTextView = -8,
	UIhappy_chipsNativeItemTextField = -9,
	UIhappy_chipsNativeItemSearchBar = -10,
	
	UIhappy_chipsNativeItemPicker = -11,
	UIhappy_chipsNativeItemDatePicker = -12,
	
	UIhappy_chipsNativeItemInfoLight = -13,
	UIhappy_chipsNativeItemInfoDark = -14,
	
	UIhappy_chipsNativeItemDisclosure = -15,
	
	UIhappy_chipsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all happy_chips instances of
