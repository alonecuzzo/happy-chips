...
/**
 The base class for all happy_chips modules
 */
...
/**
 happy_chips Platform calls this method on startup.
 */
-(void)startup;

/**
 happy_chips Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 happy_chips Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 happy_chips Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 happy_chips Platform calls this method on resume.
 @param sender The sender of the event.
 */
