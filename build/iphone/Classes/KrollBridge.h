...
@interface happy_chipsObject : KrollCoverageObject {
#else
@interface happy_chipsObject : KrollObject {
#endif
@private
...
extern NSString * happy_chips$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	happy_chipsObject *_happy_chips;
    KrollObject* console;
	BOOL shutdown;
